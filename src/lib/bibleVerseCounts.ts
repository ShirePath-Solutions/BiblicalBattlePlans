/**
 * Verse counts per chapter for every book in the Protestant Bible (KJV versification).
 * Index 0 = chapter 1 verse count, index 1 = chapter 2 verse count, etc.
 * Used by countChaptersInPassage() to determine if a verse-range passage
 * completes a chapter (i.e., the end verse equals the chapter's total verses).
 */
