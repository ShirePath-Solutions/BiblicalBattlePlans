#!/usr/bin/env node
/**
 * Generates the M'Cheyne Bible Reading Plan SQL migration
 * Based on Robert Murray M'Cheyne's classic 1842 reading plan
 */

// Complete M'Cheyne readings - 365 days, 4 readings per day
// Format: [OT1, NT1, OT2/Wisdom, NT2/Psalms]
const readings = [
  // January (Days 1-31)
  ...
  ["Numbers 2", "Psalms 36", "Ecclesiastes 12", "Philemon"],
  ...
  ["Numbers 36", "Psalms 80", "Isaiah 28", "2 John"],
  ...
  ["1 Kings 6", "Ephesians 3", "Ezekiel 36", "Psalms 86-87"],
  ["1 Kings 7", "Ephesians 4", "Ezekiel 37", "Psalms 88"],
...
function generateReadings() {
  return readings.map((dayReadings, index) => ({
    day: index + 1,
    sections: [
      { id: "family1", label: "Family 1", passages: [dayReadings[0]] },
      { id: "family2", label: "Family 2", passages: [dayReadings[1]] },
      { id: "secret1", label: "Private 1", passages: [dayReadings[2]] },
      { id: "secret2", label: "Private 2", passages: [dayReadings[3]] },
    ],
  }));
}
...
const dailyStructure = {
  ...
  sections_per_day: 4,
  section_labels: [
    { id: "family1", label: "Family Worship 1" },
    { id: "family2", label: "Family Worship 2" },
    { id: "secret1", label: "Private Devotion 1" },
    { id: "secret2", label: "Private Devotion 2" },
  ],
  readings: generateReadings(),
};

const sql = `-- Biblical Battle Plans - M'Cheyne Bible Reading Plan
-- Robert Murray M'Cheyne's classic one-year Bible reading plan (1842)
-- Reads through the OT once, NT and Psalms twice per year
...
VALUES (
  ...
  'Robert Murray M''Cheyne''s classic reading plan from 1842. Read through the Old Testament once and the New Testament and Psalms twice in one year. Four daily readings: two for family worship and two for private devotion.',
  365,
  '${JSON.stringify(dailyStructure)}'::jsonb
);

-- Notify success
DO $$
BEGIN
  RAISE NOTICE 'M''Cheyne reading plan inserted successfully!';
END $$;
`;
